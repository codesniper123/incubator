CLOSED_ROLL_FISCAL_YEAR=0
PROPERTY_LOCATION=1
NEIGHBORHOOD_CODE=2
NEIGHBORHOOD_CODE_DEFINITION=3
BLOCK_AND_LOT_NUMBER=4
VOLUME_NUMBER=5
PROPERTY_CLASS_CODE=6
...
CLOSED_ROLL_ASSESSED_IMPROVEMENT_VALUE=36
CLOSED_ROLL_ASSESSED_LAND_VALUE=37
CLOSED_ROLL_ASSESSED_PERSONAL_PROP_VALUE=38
ZIPCODE_OF_PARCEL=39
SUPERVISOR_DISTRICT=40
NEIGHBORHOODS_-_ANALYSIS_BOUNDARIES=41
LOCATION=42